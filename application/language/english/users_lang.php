...
$lang['users msg register_success']                   = "Thanks for registering, %s! Check your email for a confirmation message. Once
                                                         ...
                                                         you provided.";
$lang['users msg password_reset']                     = "Your request has been received! Check your email for a confirmation message.";	
$lang['users msg password_reset_success']             = "Your password has been reset, %s! Please check your email for your new temporary
                                                         password.";
...
$lang['users msg email_password_reset']               = "<p>Dear account holder %s!<br />
                                                         We received a request to change the password. Click the link below to create a new
														 password:<br /><br /><a href=\"%s\">%s</a><br />
                                                         Otherwise, please ignore this message!</p>";
$lang['users msg email_password_reset_title']         = "Confirm password reset";
$lang['users msg email_password_reset_success']       = "<p>Your password at %s has been reset. Click the link below to log in with your
                                                         new password:<br /><br /><strong>%s</strong><br /><br /><a href=\"%s\">%s</a>
                                                         Once logged in, be sure to change your password to something you can remember.</p>";
$lang['users msg email_password_reset_title_success'] = "Password Reset for %s";
...
$lang['users error too_many_login_attempts']          = "You've made too many attempts to log in too quickly. Please wait %s seconds and try
                                                         again.";
