...
$lang['users msg delete_confirm']                     = "Вы уверены, что хотите удалить <strong>%s</strong>? Отменить данное действие будет
                                                         невозможно.";
...
$lang['users msg register_success']                   = "%s, спасибо за регистрацию! На указанный вами адрес выслано письмо для подтверждения
                                                         регистрации.Пос ле подтверждения вашей учётной записи, вы сможете авторизироваться с
														 доступными вам полномочиями";
$lang['users msg password_reset']                     = "Ваш запрос принят! На указанный Вами адрес отправлено письмо для подтверждения сброса
                                                         пароля.";	
...
$lang['users msg email_new_account']                  = "<p>Спасибо за создание учётной записи %s. Нажмите ссылку ниже для подтверждения вашей
                                                         почты.<br /><br /><a href=\"%s\">%s</a></p>";
$lang['users msg email_new_account_title']            = "Новый аккаунт для  %s";
$lang['users msg email_password_reset']               = "<p>Уважаемый владелец аккаунта %s!<br />
                                                         Мы получили запрос на изменение пароля. Нажмите на ссылку ниже для создания нового
														 пароля:<br /><br /><a href=\"%s\">%s</a><br />
                                                         В противном случае, проигнорируйте это сообщение!</p>";
$lang['users msg email_password_reset_title']         = "Подтверждение сброса пароля  %s";
$lang['users msg email_password_reset_success']       = "<p>%s ваш пароль был сброшен. Нажмите ссылку ниже для авторизации с новым паролем
                                                         :<br /><br /><strong>%s</strong><br /><br /><a href=\"%s\">%s</a>
                                                         Авторизировавшись, не забудьте изменить пароль, на тот, который сможете запомнить.</p>";
$lang['users msg email_password_reset_title_success'] = "Сброшен пароль для %s";
...
$lang['users error too_many_login_attempts']          = "Вы сделали слишком много попыток входа в систему слишком быстро. Пожалуйста, подождите %s
