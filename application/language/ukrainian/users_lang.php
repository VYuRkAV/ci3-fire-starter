...
$lang['users input role_admin']                       = "Адмін";
...
$lang['users msg register_success']                   = "%s, Дякуємо Вам за реєстрацію! На вказану Вами адресу надіслано листа для підтвердження
                                                         реєстрації. Після підтвердження вашого облікового запису, Ви зможете авторизуватися з
														 доступними Вам повноваженнями.";
$lang['users msg password_reset']                     = "Ваш запит прийнято! На вказану Вами адресу надіслано листа для підтвердження скидання
                                                         пароля.";		 
...
$lang['users msg email_new_account']                  = "<p>Дякуємо Вам за створення облікового запису %s. Натисніть на посилання нижче, щоб
                                                         підтвердити вашу пошту.<br /><br /><a href=\"%s\">%s</a></p>";
$lang['users msg email_new_account_title']            = "Новий обліковий запис для  %s";
$lang['users msg email_password_reset']               = "<p>Шановний власнику облікового запису %s!<br />
                                                         Ми отримали запит на зміну пароля. Натисніть посилання нижче для створення нового пароля:                                                         <br /><br /><a href=\"%s\">%s</a><br />
                                                         В іншому випадку, проігноруйте це повідомлення!</p>";
$lang['users msg email_password_reset_title']         = "Підтвердження скидання пароля";
$lang['users msg email_password_reset_success']       = "<p>%s ваш пароль було скинуто. Натисніть посилання нижче для авторизації з новим паролем
...
$lang['users msg email_password_reset_title_success'] = "Скинутий пароль для %s";
...
$lang['users error too_many_login_attempts']          = "Ви зробили надто багато спроб входу в систему. Будь ласка, зачекайте %s секунд і
                                                         повторіть спробу.";
